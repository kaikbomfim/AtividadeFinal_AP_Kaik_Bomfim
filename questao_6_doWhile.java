/*Programa em Java com estrutura de repetição "DO WHILE" que permite a entrada de 3 valores e faz a contagem do primeiro deles até o segundo com o passo dado pelo terceiro. (considera que os valores digitados
...
class questao_6_doWhile{
  public static void main(){

    Scanner keyboard = new Scanner(System.in);
    double valor1, valor2, passo, counter;

    System.out.print("\n====== DO WHILE - CONTAGEM ENTRE DOIS NÚMEROS =====\n");
